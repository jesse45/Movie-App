...
router.get('/movie/:movieId', async (req, res) => {
    ...
    let api_url = "".concat(base_url, 'movie/', searchName, '?api_key=', api_key, '&language=en-US', '&append_to_response=release_dates,credits,external_ids,reviews,recommendations');
